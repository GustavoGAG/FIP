...
<%@ Register TagPrefix="asp" Namespace="Business" Assembly="Business" %>
...
<asp:Content ID="BodyMatricula" ContentPlaceHolderID="BodyMain" runat="server">
    ...
    <section class="caixa1">
        ...
        <div class="field">
            ...
            <asp:TextBox ID="TxtDataNascimento" class="input2 date" ValidationGroup="MtriculaVG"
    ...
    <section class="caixa1">
        ...
        <div class="field">
            ...
            <asp:TextBox ID="TxtDataCertidao" class="input2 date" ValidationGroup="MtriculaVG"
        ...
        <asp:UpdatePanel runat="server" EnableViewState="true">
            <ContentTemplate>
                ...
                <div class="field">
                    ...
                    <asp:DropDownList ID="ddlBairroEndereco" AutoPostBack="true" OnSelectedIndexChanged="PorraNenhuma"
                        ValidationGroup="vgEndereco" CssClass="input2" runat="server" CausesValidation="true">
                        <asp:ListItem Text="SELECIONE 0" Value="0" />
                        <asp:ListItem Text="SELECIONE 1" Value="1" />
                        <asp:ListItem Text="SELECIONE 2" Value="2" />
                        </asp:DropDownList>
                </div>
            </ContentTemplate>
        </asp:UpdatePanel>
    ...
    <div>
        ...
        <section class="caixa1">
            <asp:UpdatePanel runat="server">
                <Triggers>
                    <asp:AsyncPostBackTrigger ControlID="TxtNomeMae" />
                    <asp:AsyncPostBackTrigger ControlID="txtPai" />
